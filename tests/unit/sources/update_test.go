...
func TestUpdateSource_Success(t *testing.T) {
	...
	ctrl := &mockSourceCtrl{
		updateFn: func(_ context.Context, _ db.Querier, id, url, urlRss string) (db.Source, error) {
			s := source
			s.Url = url
			s.UrlRss = urlRss
			return s, nil
	...
	body := `{"url":"https://updated.com","url_rss":"https://updated.com/rss.xml"}`
...
func TestUpdateSource_NotFound(t *testing.T) {
	...
	ctrl := &mockSourceCtrl{
		updateFn: func(_ context.Context, _ db.Querier, _, _, _ string) (db.Source, error) {
...
func TestUpdateSource_Conflict(t *testing.T) {
	...
	body := `{"url":"https://duplicate.com","url_rss":"https://duplicate.com/rss.xml"}`
